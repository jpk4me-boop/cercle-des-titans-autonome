...
const translations = {
  ...
  'nav.financingFund': { fr: 'Fonds de financement', en: 'Financing Fund' },
  ...
  'hero.feature2': { fr: 'Fonds de financement', en: 'Financing Fund' },
  ...
  'benefits.subtitle': { fr: 'Le Cercle offre un accès facile au financement de projets sans banques ni procédures complexes', en: 'The Circle provides easy access to project financing without banks or complex procedures' },
  ...
  'benefits.community.desc': { fr: 'La force du groupe favorise la prospérité individuelle', en: 'The strength of the group fosters individual prosperity' },
  ...
  // Financing
  'financing.title': { fr: 'Financement', en: 'Financing' },
  'financing.subtitle': { fr: 'Des solutions de financement adaptées à vos besoins, sans les contraintes bancaires traditionnelles', en: 'Financing solutions adapted to your needs, without traditional bank constraints' },
  'financing.projects.title': { fr: 'Financement de projets', en: 'Project Financing' },
  ...
  'financing.investment.title': { fr: 'Investissement collectif', en: 'Collective Investment' },
  'financing.investment.desc': { fr: 'Participez à des projets communautaires rentables et partagez les bénéfices équitablement.', en: 'Participate in profitable community projects and share benefits fairly.' },
  'financing.investment.amount': { fr: 'Rendement solidaire', en: 'Solidarity Returns' },
  ...
  'financing.loan.title': { fr: 'Prêt sans intérêt', en: 'Interest-Free Loan' },
  'financing.loan.desc': { fr: 'Empruntez auprès du cercle sans aucun intérêt ni frais cachés. Remboursement flexible.', en: 'Borrow from the circle with no interest or hidden fees. Flexible repayment.' },
  'financing.loan.amount': { fr: '0% d\'intérêt', en: '0% Interest' },
  'financing.cta': { fr: 'Demander un financement', en: 'Request Financing' },
  ...
  'benefit.microFinancing': { fr: 'Possibilité de micro-financement', en: 'Micro-financing options' },
  'benefit.enhancedTontine': { fr: 'Tontine renforcée', en: 'Enhanced ROSCA' },
  'benefit.improvedBonus': { fr: 'Bonus amélioré', en: 'Improved bonus' },
  ...
  'benefit.projectFinancing': { fr: 'Possibilité de financement de projet', en: 'Project financing options' },
  'benefit.higherGains': { fr: 'Gains plus importants', en: 'Higher gains' },
  'benefit.reinforcedBonus': { fr: 'Bonus renforcé', en: 'Reinforced bonus' },
  ...
  'benefit.highBonus': { fr: 'Bonus élevé', en: 'High bonus' },
  'benefit.fundingPriority': { fr: 'Priorité au financement', en: 'Funding priority' },
  'benefit.strategicPosition': { fr: 'Position stratégique', en: 'Strategic position' },
  'benefit.privilegedAccess': { fr: 'Accès privilégié aux gros financements', en: 'Privileged access to major funding' },
  'benefit.premiumBonus': { fr: 'Bonus premium', en: 'Premium bonus' },
  ...
  'benefit.exclusiveBonus': { fr: 'Bonus exclusifs', en: 'Exclusive bonuses' },
  'benefit.eliteNetwork': { fr: 'Réseau d\'élite', en: 'Elite network' },
